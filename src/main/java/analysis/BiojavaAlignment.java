...
public class BiojavaAlignment {
	...
	/**
	 * Performs an alignment and returns the {@link AFPChain} scores between two
	 * C-alpha {@link Atom} arrays.
	 * 
	 * @param ca1
	 *            the first C-alpha array
	 * @param ca2
	 *            the second C-alpha array
	 * @param alignmentMethod
	 *            the string specifying the alignment method
	 * @return the {@link AFPChain} pf the scores between the two input
	 *         {@link Atom} array
	 */
	 ...
	 * @param ca2
	 *            the second C-alpha array
	 * @return the {@link AFPChain} of the scores between the two input
	 *         {@link Atom} array
	 */
