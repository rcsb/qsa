...
public class Pairs implements Iterable<SubstructurePair> {

	private List<SubstructurePair> pairs;

	private Pairs(List<SubstructurePair> pairs) {
		this.pairs = pairs;
	}
	 ...
	 */
	public static Pairs parseClick(Directories dirs) {
	...
	public static Pairs parseHomstrad(Directories dirs) {
		List<SubstructurePair> pairs = new ArrayList<>();
		String line = null;
	...
	public static Pairs generate(Directories dirs) {
	...
	public static Pairs parseCustom(Directories dirs) {
		List<SubstructurePair> pairs = new ArrayList<>();
		String line = null;
